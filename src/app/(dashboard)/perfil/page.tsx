  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <header className="space-y-2">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tighter">Meu Perfil Profissional</h1>
        <p className="text-gray-500 dark:text-gray-400 font-medium text-lg">Gerencie suas informações e credenciais de acesso.</p>
      </header>
