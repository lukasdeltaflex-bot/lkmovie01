    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-800 animate-in fade-in slide-in-from-bottom-10 duration-500">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400">Crie sua conta gratuita em segundos</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-500 dark:text-gray-400 ml-1">E-mail corporativo ou pessoal</label>
            <input
              type="email"
              value={email}
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-500 dark:text-gray-400 ml-1">Senha (mín. 6 caracteres)</label>
            <input
              type="password"
              value={password}
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-500 dark:text-gray-400 ml-1">Confirmar nova senha</label>
            <input
              type="password"
        ...
        <button
          ...
          className="w-full py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-white rounded-2xl font-bold shadow-sm transition-all hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center justify-center gap-3 text-sm"
        >
