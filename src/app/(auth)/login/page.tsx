    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4 font-sans">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-800 animate-in fade-in zoom-in duration-500 relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium">Acesse sua conta para continuar</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center px-1">
               ...
               <Link href="/esqueci-senha" className="text-xs text-blue-600 hover:text-blue-500 font-bold hover:underline">Esqueceu a senha?</Link>
            </div>
            <input
              type="password"
              value={password}
